-- 회원 데이터
insert into memb(mno, email, pwd, name, tel) values(1, 'user01@test.com', password('1111'), '학생1', '111-1111');
insert into memb(mno, email, pwd, name, tel) values(2, 'user02@test.com', password('1111'), '학생2', '111-1111');
insert into memb(mno, email, pwd, name, tel) values(3, 'user03@test.com', password('1111'), '학생3', '111-1111');
insert into memb(mno, email, pwd, name, tel) values(4, 'user04@test.com', password('1111'), '학생4', '111-1111');
insert into memb(mno, email, pwd, name, tel) values(5, 'user05@test.com', password('1111'), '학생5', '111-1111');
insert into memb(mno, email, pwd, name, tel) values(6, 'user06@test.com', password('1111'), '학생6', '111-1111');
insert into memb(mno, email, pwd, name, tel) values(7, 'user07@test.com', password('1111'), '학생7', '111-1111');
insert into memb(mno, email, pwd, name, tel) values(8, 'user08@test.com', password('1111'), '학생8', '111-1111');
insert into memb(mno, email, pwd, name, tel) values(9, 'user09@test.com', password('1111'), '학생9', '111-1111');
insert into memb(mno, email, pwd, name, tel) values(10, 'user10@test.com', password('1111'), '학생10', '111-1111');

insert into memb(mno, email, pwd, name, tel) values(21, 'user21@test.com', password('1111'), '강사1', '111-1111');
insert into memb(mno, email, pwd, name, tel) values(22, 'user22@test.com', password('1111'), '강사2', '111-1111');
insert into memb(mno, email, pwd, name, tel) values(23, 'user23@test.com', password('1111'), '강사3', '111-1111');
insert into memb(mno, email, pwd, name, tel) values(24, 'user24@test.com', password('1111'), '강사4', '111-1111');
insert into memb(mno, email, pwd, name, tel) values(25, 'user25@test.com', password('1111'), '강사5', '111-1111');

insert into memb(mno, email, pwd, name, tel) values(31, 'user31@test.com', password('1111'), '매니저1', '111-1111');
insert into memb(mno, email, pwd, name, tel) values(32, 'user32@test.com', password('1111'), '매니저2', '111-1111');
insert into memb(mno, email, pwd, name, tel) values(33, 'user33@test.com', password('1111'), '매니저3', '111-1111');
...
insert into lect(lno, crmno, mrno, titl, dscp, sdt, edt, qty, pric, thrs)
values(5, null, null, 'HTML5프로그래밍', 'HTML배우기', '2017-02-15', '2017-03-05', 30, 350000, 120);
