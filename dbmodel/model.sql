...
CREATE TABLE LECT_APPY (
	...
	STAT INTEGER  NULL     COMMENT '신청상태' -- 신청상태
)
COMMENT '수강신청';

-- 수강신청
ALTER TABLE LECT_APPY
	ADD CONSTRAINT PK_LECT_APPY -- 수강신청 기본키
		PRIMARY KEY (
			LANO -- 수강신청일련번호
		);
...
-- 강의실
ALTER TABLE CROOM
	ADD CONSTRAINT PK_CROOM -- 강의실 기본키
		PRIMARY KEY (
			CRMNO -- 강의실일련번호
		);
...
ALTER TABLE CROOM_PHOT
	ADD CONSTRAINT PK_CROOM_PHOT -- 강의실사진 기본키
		PRIMARY KEY (
			CPNO -- 강의실사진일련번호
		);
...
CREATE TABLE TCH_PHOT (
	...
	TNO  INTEGER      NULL     COMMENT '강사일련번호', -- 강사일련번호
	PATH VARCHAR(255) NOT NULL COMMENT '파일경로' -- 파일경로
)
COMMENT '강사사진';
...
ALTER TABLE TCH_PHOT
	ADD CONSTRAINT PK_TCH_PHOT -- 강사사진 기본키
		PRIMARY KEY (
			TPNO -- 강사사진일련번호
		);
...
ALTER TABLE TCHR_LECT
	ADD CONSTRAINT PK_TCHR_LECT -- 강사배정 기본키
		PRIMARY KEY (
			LNO, -- 강의일련번호
			TNO  -- 강사일련번호
		);
...
CREATE TABLE CODE (
	...
	PL    VARCHAR(10) NULL     COMMENT '프로그래밍언이' -- 프로그래밍언이
)
COMMENT '코드조각';

-- 코드조각
ALTER TABLE CODE
	ADD CONSTRAINT PK_CODE -- 코드조각 기본키
		PRIMARY KEY (
			CONO -- 콘텐츠일련번호
		);
...
-- 콘텐츠
ALTER TABLE CONTENT
	ADD CONSTRAINT PK_CONTENT -- 콘텐츠 기본키
		PRIMARY KEY (
			CONO -- 콘텐츠일련번호
		);
...
CREATE TABLE FEED (
	CONO  INTEGER NOT NULL COMMENT '콘텐츠일련번호', -- 콘텐츠일련번호
	CONTS TEXT    NULL     COMMENT '피드내용' -- 피드내용
)
COMMENT '피드';
...
-- 태그
CREATE TABLE TAG (
	COL    INTEGER     NOT NULL COMMENT '태그일련번호', -- 태그일련번호
	CONO   INTEGER     NOT NULL COMMENT '콘텐츠일련번호', -- 콘텐츠일련번호
...
CREATE TABLE FOLLOW (
	...
	FWNG_NO INTEGER NOT NULL COMMENT '팔료잉대상회원일련번호' -- 팔료잉대상회원일련번호
)
COMMENT '팔로잉';

-- 팔로잉
ALTER TABLE FOLLOW
	ADD CONSTRAINT PK_FOLLOW -- 팔로잉 기본키
		PRIMARY KEY (
			FOWR_NO, -- 회원일련번호
			FWNG_NO  -- 팔료잉대상회원일련번호
		);
...
ALTER TABLE PROJ_MEMB
	ADD CONSTRAINT PK_PROJ_MEMB -- 프로젝트회원 기본키
		PRIMARY KEY (
			PJNO, -- 프로젝트일련번호
			MNO   -- 회원일련번호
		);
...
ALTER TABLE DOWNLOAD
	ADD CONSTRAINT PK_DOWNLOAD -- 자료실 기본키
		PRIMARY KEY (
			CONO -- 콘텐츠일련번호
		);
...
CREATE TABLE TODO (
	...
	PJNO  INTEGER      NULL     COMMENT '프로젝트일련번호', -- 프로젝트일련번호
